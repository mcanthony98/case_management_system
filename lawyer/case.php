...
$prid = $_GET['case'];
$proqry = "SELECT * FROM client_case JOIN client ON client.client_id=client_case.client_id WHERE client_case.case_id='$prid'";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <span><?php echo $prorow['email'];?></span>
                                    </div>
                            ...
                            <div class="card-footer justify-content-between">
                                <button class="btn btn-info btn-sm " data-toggle="modal" data-target="#modal-new">New Progress</button>
                            </div>
