...
$proqry = "SELECT * FROM lawyer_case JOIN client_case ON client_case.case_id=lawyer_case.case_id JOIN client ON client.client_id=client_case.client_id WHERE lawyer_case.lawyer_id = '$lecID'";
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <a href="case.php?case=<?php echo $prorow["case_id"];?>" class="btn btn-sm btn-primary">View case </a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
