...
$prid = $_GET['case'];
$proqry = "SELECT * FROM client_case JOIN lawyer_case ON lawyer_case.case_id=client_case.case_id JOIN lawyer ON lawyer.lawyer_id=lawyer_case.lawyer_id WHERE client_case.case_id='$prid'";
