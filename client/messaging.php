...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                                                    ...
                                                    <a href="javascript:void(0)" class="msgexact" id="<?php echo $chats_row["project_id"];?>">
                                                        ...
                                                        <div class="product-info">
                                                            ...
                                                            <span class="product-description text-sm you" id="sidemessage<?php echo $chats_row["project_id"];?>">
                                                                    <?php  if($last_sms_row["msg_type"] == 1){
                                                                        echo '
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="direct-chat-messages" style="min-height:400px;" id="btmScroll">
                                            <div class="text-center pt-5">
                                                <span class="text-info h5"><i class="far fa-comments"></i> Projekt Messenger </span><br/>
                                                <img src="img/chaticon.png" loading="lazy" class="img-fluid" style="opacity:.5" alt="You can now Chat with your Favourite Sellers."  > <br/>
                                                You can now chat with Your Lawyer.<br/>
                                                Simply visit the project page and start a chat with the lawyer.<br/>
 ...
 <?php //include 'includes/fixedfooter.php';?>
